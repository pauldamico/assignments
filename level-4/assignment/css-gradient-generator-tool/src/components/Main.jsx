    ...
    <div className="main-div">
      <Card>
        ...
        <div className="linear-gradient-color-text-div">
          <p>
            background: linear-gradient({gradient.deg}deg, {gradient.topColor} ,{" "}
            {gradient.botColor});{" "}
          </p>
          <p>
            -moz-background: linear-gradient({gradient.deg}deg,{" "}
            {gradient.topColor} , {gradient.botColor});
          </p>
          <p>
            -webkit: linear-gradient({gradient.deg}deg, {gradient.topColor} ,{" "}
            {gradient.botColor})
          </p>
        </div>
      </Card>
      <Card>
        <h1>Options</h1>
        <h3>
          Color 1 <span>{gradient.topColor} </span>{" "}
          <input
        ...
        <h3>
          Color 2 <span>{gradient.botColor} </span>{" "}
          <input
            onChange={colorChangeHandler}
            name="botColor"
            value={gradient.botColor}
            type="color"
          />
        </h3>
